...
CREATE TABLE `Befund` (
  ...
  `gda` varchar(100) DEFAULT NULL,
  `diagnose` varchar(10) DEFAULT NULL,
  `massnahme` text,
  `patient_svn` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `patient_svn` (`patient_svn`),
  CONSTRAINT `befund_ibfk_1` FOREIGN KEY (`patient_svn`) REFERENCES `Patient` (`svn`)
...
INSERT INTO `Befund` VALUES (1,'Röntgen Thorax','2023-04-02','Radiologie Innsbruck','J20.9','Antibiotikatherapie','T123456781'),(2,'MRT Kopf','2023-04-03','Neurologie Klinikum Tirol','G43.9','Schmerzmittel und Ruhe','T123456782'),(3,'Blutbild','2023-04-04','Hausarzt Dr. Müller','E11.9','Ernährungsberatung und Medikation','T123456783');
...
INSERT INTO `Patient` VALUES ('T123456781','Anna','Berger'),('T123456782','Lukas','Gruber'),('T123456783','Maria','Steiner');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-04-03 22:34:15',NULL),('diagnostics.include_raw','OFF','2024-04-03 22:34:15',NULL),('ps_thread_trx_info.max_length','65535','2024-04-03 22:34:15',NULL),('statement_performance_analyzer.limit','100','2024-04-03 22:34:15',NULL),('statement_performance_analyzer.view',NULL,'2024-04-03 22:34:15',NULL),('statement_truncate_len','64','2024-04-03 22:34:15',NULL);
...
-- Dump completed on 2024-04-04  1:02:36
